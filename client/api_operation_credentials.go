...
func (r ApiOpscredentialsCreateRequest) OperationCredentialsCreateCommand(operationCredentialsCreateCommand OperationCredentialsCreateCommand) ApiOpscredentialsCreateRequest {
	r.operationCredentialsCreateCommand = &operationCredentialsCreateCommand
	return r
}

func (r ApiOpscredentialsCreateRequest) Execute() (*ApiResponse, *http.Response, error) {
	return r.ApiService.OpscredentialsCreateExecute(r)
}
...
func (a *OperationCredentialsApiService) OpscredentialsCreateExecute(r ApiOpscredentialsCreateRequest) (*ApiResponse, *http.Response, error) {
	...
	if r.operationCredentialsCreateCommand == nil {
		return localVarReturnValue, nil, reportError("operationCredentialsCreateCommand is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.operationCredentialsCreateCommand
	if r.ctx != nil {
...
func (r ApiOpscredentialsDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.OpscredentialsDeleteExecute(r)
}
...
func (a *OperationCredentialsApiService) OpscredentialsDeleteExecute(r ApiOpscredentialsDeleteRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/opscredentials/{id}"
...
func (r ApiOpscredentialsLockManagerRequest) OperationCredentialLockManagerCommand(operationCredentialLockManagerCommand OperationCredentialLockManagerCommand) ApiOpscredentialsLockManagerRequest {
	r.operationCredentialLockManagerCommand = &operationCredentialLockManagerCommand
	return r
}

func (r ApiOpscredentialsLockManagerRequest) Execute() (*http.Response, error) {
	return r.ApiService.OpscredentialsLockManagerExecute(r)
}
...
func (a *OperationCredentialsApiService) OpscredentialsLockManagerExecute(r ApiOpscredentialsLockManagerRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/opscredentials/lockmanager"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.operationCredentialLockManagerCommand == nil {
		return nil, reportError("operationCredentialLockManagerCommand is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.operationCredentialLockManagerCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (r ApiOpscredentialsMakeDefaultRequest) OperationCredentialsMakeDefaultCommand(operationCredentialsMakeDefaultCommand OperationCredentialsMakeDefaultCommand) ApiOpscredentialsMakeDefaultRequest {
	r.operationCredentialsMakeDefaultCommand = &operationCredentialsMakeDefaultCommand
	return r
}

func (r ApiOpscredentialsMakeDefaultRequest) Execute() (*http.Response, error) {
	return r.ApiService.OpscredentialsMakeDefaultExecute(r)
}
...
func (a *OperationCredentialsApiService) OpscredentialsMakeDefaultExecute(r ApiOpscredentialsMakeDefaultRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/opscredentials/makedefault"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.operationCredentialsMakeDefaultCommand == nil {
		return nil, reportError("operationCredentialsMakeDefaultCommand is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.operationCredentialsMakeDefaultCommand
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["Bearer"]; ok {
...
func (a *OperationCredentialsApiService) OpscredentialsMetricNamesExecute(r ApiOpscredentialsMetricNamesRequest) (interface{}, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/opscredentials/{id}/metric/names"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
