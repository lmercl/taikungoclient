...
func (r ApiUsergroupsBindProjectsGroupRequest) Execute() (*http.Response, error) {
...
func (r ApiUsergroupsUserGroupUsersRequest) OrganizationId(organizationId int32) ApiUsergroupsUserGroupUsersRequest {
	r.organizationId = &organizationId
	return r
}

func (r ApiUsergroupsUserGroupUsersRequest) Execute() ([]UserListForUserGroupDto, *http.Response, error) {
...
func (a *UserGroupApiService) UsergroupsUserGroupUsersExecute(r ApiUsergroupsUserGroupUsersRequest) ([]UserListForUserGroupDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/usergroups/users/{userGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"userGroupId"+"}", url.PathEscape(parameterValueToString(r.userGroupId, "userGroupId")), -1)
