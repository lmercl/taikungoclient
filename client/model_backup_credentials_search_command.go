...
// checks if the BackupCredentialsSearchCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BackupCredentialsSearchCommand{}

// BackupCredentialsSearchCommand struct for BackupCredentialsSearchCommand
...
func NewBackupCredentialsSearchCommand() *BackupCredentialsSearchCommand {
	this := BackupCredentialsSearchCommand{}
	return &this
}
...
func (o *BackupCredentialsSearchCommand) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *BackupCredentialsSearchCommand) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *BackupCredentialsSearchCommand) SetSearchTermNil() {
...
func (o BackupCredentialsSearchCommand) MarshalJSON() ([]byte, error) {
...
func (o BackupCredentialsSearchCommand) ToMap() (map[string]interface{}, error) {
...
type NullableBackupCredentialsSearchCommand struct {
	value *BackupCredentialsSearchCommand
	isSet bool
}

func (v NullableBackupCredentialsSearchCommand) Get() *BackupCredentialsSearchCommand {
	return v.value
}

func (v *NullableBackupCredentialsSearchCommand) Set(val *BackupCredentialsSearchCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableBackupCredentialsSearchCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableBackupCredentialsSearchCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBackupCredentialsSearchCommand(val *BackupCredentialsSearchCommand) *NullableBackupCredentialsSearchCommand {
	return &NullableBackupCredentialsSearchCommand{value: val, isSet: true}
}

func (v NullableBackupCredentialsSearchCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBackupCredentialsSearchCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
