...
func (r ApiInvoicesDownloadRequest) Execute() (string, *http.Response, error) {
...
// Execute executes the request
//  @return string
func (a *InvoicesApiService) InvoicesDownloadExecute(r ApiInvoicesDownloadRequest) (string, *http.Response, error) {
	var (
