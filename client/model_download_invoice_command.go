...
// checks if the DownloadInvoiceCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DownloadInvoiceCommand{}
...
func (o DownloadInvoiceCommand) ToMap() (map[string]interface{}, error) {
...
type NullableDownloadInvoiceCommand struct {
	value *DownloadInvoiceCommand
	isSet bool
}

func (v NullableDownloadInvoiceCommand) Get() *DownloadInvoiceCommand {
	return v.value
}

func (v *NullableDownloadInvoiceCommand) Set(val *DownloadInvoiceCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableDownloadInvoiceCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableDownloadInvoiceCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDownloadInvoiceCommand(val *DownloadInvoiceCommand) *NullableDownloadInvoiceCommand {
	return &NullableDownloadInvoiceCommand{value: val, isSet: true}
}

func (v NullableDownloadInvoiceCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDownloadInvoiceCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
