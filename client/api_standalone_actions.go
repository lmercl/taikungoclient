...
func (r ApiStandaloneactionsDownloadRdpRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *StandaloneActionsApiService) StandaloneactionsDownloadRdpExecute(r ApiStandaloneactionsDownloadRdpRequest) (*http.Response, error) {
	var (
