...
type SlackConfigurationDto struct {
	...
	SlackType NullableString `json:"slackType,omitempty"`
}
...
// GetSlackType returns the SlackType field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *SlackConfigurationDto) GetSlackType() string {
	if o == nil || IsNil(o.SlackType.Get()) {
		var ret string
		return ret
	}
	return *o.SlackType.Get()
}
...
// SetSlackType gets a reference to the given NullableString and assigns it to the SlackType field.
func (o *SlackConfigurationDto) SetSlackType(v string) {
	o.SlackType.Set(&v)
}
// SetSlackTypeNil sets the value for SlackType to be an explicit nil
func (o *SlackConfigurationDto) SetSlackTypeNil() {
	o.SlackType.Set(nil)
}
...
func (o SlackConfigurationDto) ToMap() (map[string]interface{}, error) {
	...
	if o.SlackType.IsSet() {
		toSerialize["slackType"] = o.SlackType.Get()
	}
