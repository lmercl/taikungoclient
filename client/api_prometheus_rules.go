...
func (r ApiPrometheusrulesDetailsRequest) OrganizationId(organizationId int32) ApiPrometheusrulesDetailsRequest {
	r.organizationId = &organizationId
	return r
}

func (r ApiPrometheusrulesDetailsRequest) Execute() ([]CommonDropdownIsBoundDto, *http.Response, error) {
	return r.ApiService.PrometheusrulesDetailsExecute(r)
}
...
func (a *PrometheusRulesApiService) PrometheusrulesDetailsExecute(r ApiPrometheusrulesDetailsRequest) ([]CommonDropdownIsBoundDto, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/prometheusrules/details"
