...
func (r ApiProxmoxHypervisorListRequest) Execute() ([]string, *http.Response, error) {
...
// Execute executes the request
//  @return []string
func (a *ProxmoxCloudCredentialApiService) ProxmoxHypervisorListExecute(r ApiProxmoxHypervisorListRequest) ([]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiProxmoxVmTemplateListRequest) Execute() ([]int64, *http.Response, error) {
...
// Execute executes the request
//  @return []int64
func (a *ProxmoxCloudCredentialApiService) ProxmoxVmTemplateListExecute(r ApiProxmoxVmTemplateListRequest) ([]int64, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
