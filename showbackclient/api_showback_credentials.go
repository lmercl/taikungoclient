...
func (r ApiShowbackcredentialsLockManagementRequest) Execute() (*http.Response, error) {
...
func (a *ShowbackCredentialsApiService) ShowbackcredentialsLockManagementExecute(r ApiShowbackcredentialsLockManagementRequest) (*http.Response, error) {
	...
	if r.showbackCredentialLockCommand == nil {
		return nil, reportError("showbackCredentialLockCommand is required and must be specified")
	}
