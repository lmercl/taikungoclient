...
// checks if the PodsSearchCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PodsSearchCommand{}
...
func (o PodsSearchCommand) ToMap() (map[string]interface{}, error) {
...
type NullablePodsSearchCommand struct {
	value *PodsSearchCommand
	isSet bool
}

func (v NullablePodsSearchCommand) Get() *PodsSearchCommand {
	return v.value
}

func (v *NullablePodsSearchCommand) Set(val *PodsSearchCommand) {
	v.value = val
	v.isSet = true
}

func (v NullablePodsSearchCommand) IsSet() bool {
	return v.isSet
}

func (v *NullablePodsSearchCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePodsSearchCommand(val *PodsSearchCommand) *NullablePodsSearchCommand {
	return &NullablePodsSearchCommand{value: val, isSet: true}
}

func (v NullablePodsSearchCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePodsSearchCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
