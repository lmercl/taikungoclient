...
type ServerListDto struct {
	...
	ProxmoxRole NullableString `json:"proxmoxRole,omitempty"`
...
func (o *ServerListDto) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *ServerListDto) SetCloudTypeNil() {
	o.CloudType.Set(nil)
}
...
// GetProxmoxRole returns the ProxmoxRole field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ServerListDto) GetProxmoxRole() string {
	if o == nil || IsNil(o.ProxmoxRole.Get()) {
		var ret string
		return ret
	}
	return *o.ProxmoxRole.Get()
}
...
// SetProxmoxRole gets a reference to the given NullableString and assigns it to the ProxmoxRole field.
func (o *ServerListDto) SetProxmoxRole(v string) {
	o.ProxmoxRole.Set(&v)
}
// SetProxmoxRoleNil sets the value for ProxmoxRole to be an explicit nil
func (o *ServerListDto) SetProxmoxRoleNil() {
	o.ProxmoxRole.Set(nil)
}
...
func (o ServerListDto) ToMap() (map[string]interface{}, error) {
	...
	if o.ProxmoxRole.IsSet() {
		toSerialize["proxmoxRole"] = o.ProxmoxRole.Get()
	}
