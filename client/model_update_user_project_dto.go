...
// checks if the UpdateUserProjectDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateUserProjectDto{}
...
func (o UpdateUserProjectDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateUserProjectDto struct {
	value *UpdateUserProjectDto
	isSet bool
}

func (v NullableUpdateUserProjectDto) Get() *UpdateUserProjectDto {
	return v.value
}

func (v *NullableUpdateUserProjectDto) Set(val *UpdateUserProjectDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateUserProjectDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateUserProjectDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateUserProjectDto(val *UpdateUserProjectDto) *NullableUpdateUserProjectDto {
	return &NullableUpdateUserProjectDto{value: val, isSet: true}
}

func (v NullableUpdateUserProjectDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateUserProjectDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
