...
type NotificationListDto struct {
	...
	ActionStatus NullableString `json:"actionStatus,omitempty"`
...
// GetActionStatus returns the ActionStatus field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NotificationListDto) GetActionStatus() string {
	if o == nil || IsNil(o.ActionStatus.Get()) {
		var ret string
		return ret
	}
	return *o.ActionStatus.Get()
}
...
func (o *NotificationListDto) GetActionStatusOk() (*string, bool) {
	...
	return o.ActionStatus.Get(), o.ActionStatus.IsSet()
}

// HasActionStatus returns a boolean if a field has been set.
func (o *NotificationListDto) HasActionStatus() bool {
	if o != nil && o.ActionStatus.IsSet() {
		return true
	}
...
// SetActionStatus gets a reference to the given NullableString and assigns it to the ActionStatus field.
func (o *NotificationListDto) SetActionStatus(v string) {
	o.ActionStatus.Set(&v)
}
// SetActionStatusNil sets the value for ActionStatus to be an explicit nil
func (o *NotificationListDto) SetActionStatusNil() {
	o.ActionStatus.Set(nil)
}
...
func (o *NotificationListDto) SetCategoryNil() {
	o.Category.Set(nil)
}
...
func (o NotificationListDto) ToMap() (map[string]interface{}, error) {
	...
	if o.ActionStatus.IsSet() {
		toSerialize["actionStatus"] = o.ActionStatus.Get()
	}
	if o.Username.IsSet() {
