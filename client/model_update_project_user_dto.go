...
// checks if the UpdateProjectUserDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateProjectUserDto{}

// UpdateProjectUserDto struct for UpdateProjectUserDto
...
func (o *UpdateProjectUserDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *UpdateProjectUserDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o UpdateProjectUserDto) MarshalJSON() ([]byte, error) {
...
func (o UpdateProjectUserDto) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateProjectUserDto struct {
	value *UpdateProjectUserDto
	isSet bool
}

func (v NullableUpdateProjectUserDto) Get() *UpdateProjectUserDto {
	return v.value
}

func (v *NullableUpdateProjectUserDto) Set(val *UpdateProjectUserDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateProjectUserDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateProjectUserDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateProjectUserDto(val *UpdateProjectUserDto) *NullableUpdateProjectUserDto {
	return &NullableUpdateProjectUserDto{value: val, isSet: true}
}

func (v NullableUpdateProjectUserDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateProjectUserDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
