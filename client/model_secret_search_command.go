...
// checks if the SecretSearchCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecretSearchCommand{}

// SecretSearchCommand struct for SecretSearchCommand
...
func (o *SecretSearchCommand) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *SecretSearchCommand) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *SecretSearchCommand) SetSearchTermNil() {
...
func (o SecretSearchCommand) MarshalJSON() ([]byte, error) {
...
func (o SecretSearchCommand) ToMap() (map[string]interface{}, error) {
...
type NullableSecretSearchCommand struct {
	value *SecretSearchCommand
	isSet bool
}

func (v NullableSecretSearchCommand) Get() *SecretSearchCommand {
	return v.value
}

func (v *NullableSecretSearchCommand) Set(val *SecretSearchCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretSearchCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretSearchCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretSearchCommand(val *SecretSearchCommand) *NullableSecretSearchCommand {
	return &NullableSecretSearchCommand{value: val, isSet: true}
}

func (v NullableSecretSearchCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretSearchCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
