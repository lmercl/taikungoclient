...
// checks if the BillingCredentialsSearchCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingCredentialsSearchCommand{}

// BillingCredentialsSearchCommand struct for BillingCredentialsSearchCommand
type BillingCredentialsSearchCommand struct {
...
func NewBillingCredentialsSearchCommand() *BillingCredentialsSearchCommand {
	this := BillingCredentialsSearchCommand{}
	return &this
}
...
func (o *BillingCredentialsSearchCommand) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *BillingCredentialsSearchCommand) SetOffsetNil() {
	o.Offset.Set(nil)
}
...
func (o *BillingCredentialsSearchCommand) SetSearchTermNil() {
...
func (o BillingCredentialsSearchCommand) MarshalJSON() ([]byte, error) {
...
func (o BillingCredentialsSearchCommand) ToMap() (map[string]interface{}, error) {
...
type NullableBillingCredentialsSearchCommand struct {
	value *BillingCredentialsSearchCommand
	isSet bool
}

func (v NullableBillingCredentialsSearchCommand) Get() *BillingCredentialsSearchCommand {
	return v.value
}

func (v *NullableBillingCredentialsSearchCommand) Set(val *BillingCredentialsSearchCommand) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingCredentialsSearchCommand) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingCredentialsSearchCommand) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingCredentialsSearchCommand(val *BillingCredentialsSearchCommand) *NullableBillingCredentialsSearchCommand {
	return &NullableBillingCredentialsSearchCommand{value: val, isSet: true}
}

func (v NullableBillingCredentialsSearchCommand) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingCredentialsSearchCommand) UnmarshalJSON(src []byte) error {
	v.isSet = true
